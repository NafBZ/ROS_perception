...
# Label map
voc_labels = ('__background__','backpack', 'umbrella', 'bottle', 'wine glass', 'cup', 'fork', 'knife', 'spoon', 'bowl', 'chair', 'couch', 'tv', 'laptop', 'mouse', 'remote', 'keyboard', 'cell phone', 'microwave', 'book')
...
def calculate_mAP(
    ...
    for c in range(1, n_classes):
        ...
        cumul_recall = (
            cumul_true_positives / true_class_images.sum().item()
        )  # (n_class_detections)
...
def detect_objects(
    ...
    for i in range(batch_size):
        ...
        for c in range(1, n_classes):
            ...
            #print('suppress',suppress) # (n_qualified)
